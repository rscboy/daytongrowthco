...
export const metadata: Metadata = {
  title: "The Better Quote Program™ | Human-Led Quote Shopping",
  ...
  openGraph: { title: "The Better Quote Program™ | DaytonGrowthCo.", description: "Upload an expensive written quote. Real people shop it for a better qualifying, comparable local option.", url, images: ["/thumbnail.jpeg"] },
...
const quoteSchema = {
  ...
  "@graph": [
    ...
    { "@type": "WebPage", "@id": `${url}#webpage`, url, name: "The Better Quote Program™", description: "Human-led quote shopping for an expensive service quote.", isPartOf: { "@id": "https://www.daytongrowth.co/#website" }, inLanguage: "en-US", dateModified: "2026-08-07" },
    { "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Home", item: "https://www.daytongrowth.co/" }, { "@type": "ListItem", position: 2, name: "The Better Quote Program™", item: url }] },
  ],
};
