...
export const metadata: Metadata = {
  ...
  description: "Clear public pricing for DaytonGrowthCo's Website Migration Program™, HVAC Google Review Growth Program™, and Better Quote Program™ success-fee schedule.",
