...
const crmEndpoint = "https://daytongrowthco-crm.vercel.app/api/internal/funnel-progress";
...
export async function POST(request: Request) {
  ...
  try {
    const response = await fetch(crmEndpoint, { method: "POST", headers: { authorization: `Bearer ${secret}`, "content-type": "application/json" }, body: JSON.stringify(body), cache: "no-store" });
