    ...
    <div className="taa-shell">
      ...
      <div className="taa-layout">
        ...
        <section className="taa-results" aria-labelledby="results-heading">
          <div className="taa-results-heading"><div><p className="taa-eyebrow">Your forecast</p><h2 id="results-heading">The numbers at a glance</h2></div><span className="taa-campaign-tag">{state.campaign}{state.cpa >= 60 && " / stress test"}</span></div>
